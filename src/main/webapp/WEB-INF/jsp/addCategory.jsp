...
<body>
	...
	<div class="container center">
		...
		<form:form modelAttribute="category"
			action="/Project4JPA/admin/category/addCategory" method="post"
			class="form-horizontal">


			<div class="form-group">
				<label class="control-label col-sm-2" for="categoryTitle">Category
					Title</label>
				<div class="col-sm-4">
					<form:input path="name" type="text" class="form-control"
						id="categoryTitle" placeholder="Title" />
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<form:textarea path="categoryDescription" type="text"
