			...
			<tr>
				...
				<c:forEach items="${events}" var="event">
					...
					<tr>
						...
						<td><a
							href="<spring:url value="/admin/memberEvent/list/${event.eventId}" />"
							class="btn btn-success"> <span
								class="glyphicon glyphicon-edit" /></span>Members
						</a> <a
							href="<spring:url value="/admin/event/getdetails/${event.eventId}" />"
							class="btn btn-success"> <span
								class="glyphicon glyphicon-edit" /></span>Details
						</a> <a
